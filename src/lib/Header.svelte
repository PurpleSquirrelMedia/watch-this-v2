...
>
	<button on:click={logoClick} class="flex items-center mb-4 md:mb-0">
		<img src="/psm-logo.png" alt="Purple Squirrel Media" class="h-10" />
	</button>
	<a
		...
		href="https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2FPurpleSquirrelMedia%2Fwatch-this-v2&env=VITE_OPENAI_API_KEY&envDescription=Open%20AI%20API%20key&demo-title=watchthis.dev&demo-url=https%3A%2F%2Fwatchthis.dev"
	>
